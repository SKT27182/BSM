...
************************************************************************
      ...
      PARAMETER (NFL=22,NPROB=88+1,NPAR=25)
      ...
      INTEGER NFLAG,UNCERTFLAG,ITRY,SFFLAG,GRFLAG,MWFLAG,CFLAG(6)
      INTEGER IND,strlen
...
*******************************************************************
      ...
      INTEGER GMFLAG,NFLAG,GRFLAG,MWFLAG,CFLAG(6)
...
*********************************************************************
      ...
      INTEGER OMGFLAG,MAFLAG,MOFLAG,GMFLAG,MWFLAG
     ...
     . LDN,LDNN,LTN,LTNN,LBN,LBNN,LLN,LLNN,MUN,MUNN
      ...
      WRITE(17,10)"  no electroweak symmetry breaking       ",NFAIL(20)
      S=0
      DO I=1,7
       S=S+NFAIL(I)
      ENDDO
      ...
      IF(GMFLAG.NE.0)THEN
       WRITE(17,10)"  MSMES=/=MSREF                         ",NFAIL(21)
       WRITE(17,10)"  MSMES=/=MSREF + violating constraints ",NFAIL(22)
      ENDIF
      S=0
      DO I=11,15
       S=S+NFAIL(I)
     ...
     .  WRITE(17,20)" - Delta_MW                                       "
      ...
      IF(TOT.GT.0)THEN
       ...
       WRITE(17,*)
       WRITE(17,30)" MSUSYEFF: ",MSUSYEFFN,MSUSYEFFNN,
     .                          DEV(MSUSYEFFN,MSUSYEFFNN)
       WRITE(17,30)" MMESS: ",MMESSN,MMESSNN,DEV(MMESSN,MMESSNN)
