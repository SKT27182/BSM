...
************************************************************************
     ...
     . LPPM,LPPT,LTTM,LTTT,JM,JL
      ...
      COMMON/GMFILES/IFILE,OFILE,EFILE
...
*******************************************************************
      ...
      INTEGER N0,NLOOP,NBER,NPAR,OUTFLAG,GRFLAG,MWFLAG,CFLAG(6)
...
*   Check for errors
 ...
 29   CLOSE(15)
      ...
      DO I=1,5
       ...
       ENDIF
      ENDDO
      IF(CFLAG(6).LT.0 .OR. CFLAG(6).GT.2)THEN
       WRITE(0,1)"LHC CONSTRAINT FLAG MUST BE IN [0-2]"
       ERR=1
      ENDIF
...
*********************************************************************
      ...
      INTEGER I,IFAIL,NSUSY,NGUT,NMES,OUTFLAG,GRFLAG,MWFLAG,NBIN
     ...
     . WRITE(16,930) 4,"# Negative sfermion mass squared"
      IF (IFAIL.EQ.11)
     . WRITE(16,930) 4,"# Integration problem in RGESGM"
      IF (IFAIL.EQ.12)
     . WRITE(16,930) 4,"# Integration problem in RGESUNIGM"
      IF (IFAIL.EQ.13)
     . WRITE(16,930) 4,"# Integration problem in RGESINVGM"
      IF (IFAIL.EQ.14)
     . WRITE(16,930) 4,"# Integration problem in RGESGMGUT"
      IF (IFAIL.EQ.15)
     . WRITE(16,930) 4,"# Integration problem in LPTSOLVE"
      IF (IFAIL.EQ.16.OR.IFAIL.EQ.17.OR.IFAIL.EQ.18.OR.IFAIL.EQ.19)
     . WRITE(16,930) 4,"# Convergence Problem"
      IF (IFAIL.EQ.20)
     . WRITE(16,930) 4,"# No electroweak symmetry breaking"
      IF (IFAIL.EQ.21.OR.IFAIL.EQ.22)
     . WRITE(16,930) 4,"# MSMES=/=MSREF"

      WRITE(16,899) "# Input parameters"
      WRITE(16,899) "BLOCK MODSEL"
      WRITE(16,921) 3,1,"NMSSM particle content"
      WRITE(16,921) 1,2,"IMOD"
      WRITE(16,921) 10,0,"ISCAN"
      WRITE(16,921) 8,PFLAG,"Precision for Higgs masses"
      WRITE(16,921) 12,GMFLAG,"GMSB scenario at MMESS"
      ...
      WRITE(16,901) 1,1./ALEMMZ,"ALPHA_EM^-1(MZ)"
      ...
      WRITE(16,901) 1,MSUSYEFF,"MSUSYEFF"
      WRITE(16,901) 2,MMESS,"MMES"
      WRITE(16,901) 3,TANB,"TANB at MZ"
      WRITE(16,901) 4,SIGMU,"SIGMU"
      IF(N5.NE.1d0)WRITE(16,901) 5,N5,"N5"

      WRITE(16,899) "BLOCK EXTPAR"
      WRITE(16,901) 61,PAR(1),"LAMBDA at MSUSY"
      IF(MAFLAG.EQ.-3 .OR. MAFLAG.EQ.-4)THEN
       WRITE(16,901) 62,PAR(2),"KAPPA at MSUSY"
      ELSE
       WRITE(16,920) 62,PAR(2),"KAPPA at MSUSY"
      ENDIF
      IF(GMFLAG.EQ.0)THEN
       WRITE(16,901) 63,ALINP,"ALAMBDA at MMES"
      ELSE
       WRITE(16,920) 63,ALINP,"ALAMBDA at MMES"
      ENDIF
      WRITE(16,920) 65,PAR(4),"MUEFF at MSUSY"
      IF(MAFLAG.EQ.-1 .OR. MAFLAG.EQ.-2)THEN
       IF(XIFINP.NE.0d0)
     .  WRITE(16,901) 66,XIFINP,"XIF at MMES"
      ELSE
       WRITE(16,920) 66,XIFMES,"XIF at MMES"
      ENDIF
      IF(MAFLAG.EQ.-1 .OR. MAFLAG.EQ.-3)THEN
       IF(XISINP.NE.0d0)
     .  WRITE(16,901) 67,XISINP,"XIS at MMES"
      ELSE
       WRITE(16,920) 67,XISMES,"XIS at MMES"
      ENDIF
      IF(MUPINP.NE.0d0)
     .  WRITE(16,901) 68,MUPINP,"MUP at MMES "
      IF(MSPINP.NE.0d0)
     .  WRITE(16,901) 69,MSPINP,"MSP at MMES "
      IF(MAFLAG.EQ.-2 .OR. MAFLAG.EQ.-4)THEN
       WRITE(16,901) 70,MSINP,"MS at MMES"
      ELSE
       WRITE(16,920) 70,MSMES,"MS at MMES"
      ENDIF
      IF(GMFLAG.NE.0)
     . WRITE(16,920) 71,MSREF,"MS_REF"
      IF(GMFLAG.NE.0)
     . WRITE(16,920) 72,D,"DELTA"
      IF((GMFLAG.EQ.1 .OR. GMFLAG.EQ.3) .AND. XIU.NE.0d0)
     .  WRITE(16,901) 73,XIU,"XiU at MGUT"
      IF((GMFLAG.EQ.2 .OR. GMFLAG.EQ.4) .AND. LPPMES.NE.0d0)
     .  WRITE(16,901) 74,LPPMES,"LPP at MMES"
      IF((GMFLAG.EQ.2 .OR. GMFLAG.EQ.4) .AND. LTTMES.NE.0d0)
     .  WRITE(16,901) 75,LTTMES,"LTT at MMES"
      IF((GMFLAG.EQ.1 .OR. GMFLAG.EQ.2) .AND. LUMES.NE.0d0)
     .  WRITE(16,901) 76,LUMES,"LU at MMES"
      IF((GMFLAG.EQ.1 .OR. GMFLAG.EQ.2) .AND. LDMES.NE.0d0)
     .  WRITE(16,901) 77,LDMES,"LD at MMES"
      IF(GMFLAG.NE.0 .AND. LTMES.NE.0d0)
     .  WRITE(16,901) 78,LTMES,"LT at MMES"
      IF(GMFLAG.NE.0 .AND. LBMES.NE.0d0)
     .  WRITE(16,901) 79,LBMES,"LB at MMES"
      IF((GMFLAG.EQ.1 .OR. GMFLAG.EQ.2) .AND. LLMES.NE.0d0)
     .  WRITE(16,901) 80,LLMES,"LL at MMES"
     ...
     .  RETURN
      ...
      WRITE(16,902) 36,PMASS(1),"lightest pseudoscalar"
      WRITE(16,902) 46,PMASS(2),"second pseudoscalar"
      ...
      WRITE(16,902) 1000013,MLL," ~mu_L"
      WRITE(16,902) 2000013,MLR," ~mu_R"
...
*  From IF(OUTFLAG.NE.1)
      ...
      WRITE(16,899) "# "
      WRITE(16,899) "# NMSSM SPECIFIC PARAMETERS AT THE SUSY SCALE"
      ...
      WRITE(16,899) "# "
       ...
       IF(OUTFLAG.NE.1) THEN
      WRITE(16,899) "# GAUGE AND YUKAWA COUPLINGS AT THE MES SCALE"
      WRITE(16,907) "BLOCK MESGAUGE Q=",MMESS," # (MES SCALE)"
      WRITE(16,901) 1,DSQRT(G1MES),"g1(MMES,DR_bar)"
      WRITE(16,901) 2,DSQRT(G2MES),"g2(MMES,DR_bar)"
      WRITE(16,901) 3,DSQRT(G3MES),"g3(MMES,DR_bar)"

      WRITE(16,907) "BLOCK MESYU Q=",MMESS," # (MES SCALE)"
      WRITE(16,903) 3,3,HTMES/DSQRT(DABS(HTMES)),
     .            "HTOP(MMES,DR_bar)"
      WRITE(16,907) "BLOCK MESYD Q=",MMESS," # (MES SCALE)"
      WRITE(16,903) 3,3,HBMES/DSQRT(DABS(HBMES)),
     .            "HBOT(MMES,DR_bar)"
      WRITE(16,907) "BLOCK MESYE Q=",MMESS," # (MES SCALE)"
      WRITE(16,903) 3,3,HLMES/DSQRT(DABS(HLMES)),
     .        "HTAU(MMES,DR_bar)"

      WRITE(16,899) "# "
      WRITE(16,899) "# SOFT TRILINEAR COUPLINGS AT THE MES SCALE"
      WRITE(16,907) "BLOCK MESAU Q=",MMESS," # (MES SCALE)"
      WRITE(16,903) 3,3,ATMES,"ATOP"
      WRITE(16,907) "BLOCK MESAD Q=",MMESS," # (MES SCALE)"
      WRITE(16,903) 3,3,ABMES,"ABOT"
      WRITE(16,907) "BLOCKMES AE Q=",MMESS," # (MES SCALE)"
      WRITE(16,903) 2,2,AMUMES,"AMUON"
      WRITE(16,903) 3,3,ATAUMES,"ATAU"

      WRITE(16,899) "# "
      WRITE(16,899) "# SOFT MASSES SQUARED AT THE MES SCALE"
      WRITE(16,907) "BLOCK MESMSOFT Q=",MMESS," # (MES SCALE)"
      WRITE(16,901) 1,M1MES,"M1"
      WRITE(16,901) 2,M2MES,"M2"
      WRITE(16,901) 3,M3MES,"M3"
      WRITE(16,901) 21,MHDMES,"M_HD^2"
      WRITE(16,901) 22,MHUMES,"M_HU^2"
      WRITE(16,901) 31,MLMES/DSQRT(DABS(MLMES)),"M_eL"
      WRITE(16,901) 32,MLMES/DSQRT(DABS(MLMES)),"M_muL"
      WRITE(16,901) 33,ML3MES/DSQRT(DABS(ML3MES)),"M_tauL"
      WRITE(16,901) 34,MEMES/DSQRT(DABS(MEMES)),"M_eR"
      WRITE(16,901) 35,MEMES/DSQRT(DABS(MEMES)),"M_muR"
      WRITE(16,901) 36,ME3MES/DSQRT(DABS(ME3MES)),"M_tauR"
      WRITE(16,901) 41,MQMES/DSQRT(DABS(MQMES)),"M_q1L"
      WRITE(16,901) 42,MQMES/DSQRT(DABS(MQMES)),"M_q2L"
      WRITE(16,901) 43,MQ3MES/DSQRT(DABS(MQ3MES)),"M_q3L"
      WRITE(16,901) 44,MUMES/DSQRT(DABS(MUMES)),"M_uR"
      WRITE(16,901) 45,MUMES/DSQRT(DABS(MUMES)),"M_cR"
      WRITE(16,901) 46,MU3MES/DSQRT(DABS(MU3MES)),"M_tR"
      WRITE(16,901) 47,MDMES/DSQRT(DABS(MDMES)),"M_dR"
      WRITE(16,901) 48,MDMES/DSQRT(DABS(MDMES)),"M_sR"
      WRITE(16,901) 49,MD3MES/DSQRT(DABS(MD3MES)),"M_bR"

      WRITE(16,899) "# "
      WRITE(16,899) "# NMSSM SPECIFIC PARAMETERS AT THE MES SCALE"
      WRITE(16,907) "BLOCK MESNMSSMRUN Q=",MMESS," # (MES SCALE)"
      WRITE(16,901) 1,LMES/DSQRT(DABS(LMES)),"LAMBDA(MMES,DR_bar)"
      WRITE(16,901) 2,KMES,"KAPPA(MMES,DR_bar)"
      WRITE(16,901) 3,ALMES,"ALAMBDA"
      WRITE(16,901) 4,AKMES,"AKAPPA"
      WRITE(16,901) 6,XIFMES,"XIF"
      WRITE(16,901) 7,XISMES,"XIS"
      WRITE(16,901) 8,MUPMES,"MUP"
      WRITE(16,901) 9,MSPMES,"MSP"
      WRITE(16,901) 10,MSMES,"MS^2"
      WRITE(16,901) 11,M3HMES,"M3H"
      WRITE(16,901) 12,LPPMES,"LPP"
      WRITE(16,901) 13,LTTMES,"LTT"
      WRITE(16,901) 14,LUMES,"LU"
      WRITE(16,901) 15,LDMES,"LD"
      WRITE(16,901) 16,LTMES,"LT"
      WRITE(16,901) 17,LBMES,"LB"
      WRITE(16,901) 18,LLMES,"LL"
      WRITE(16,899) "# "
     ...
     .        "g1(MGUT), GUT normalization"
       WRITE(16,901) 2,DSQRT(G2GUT),"g2(MGUT)"
       WRITE(16,901) 3,DSQRT(G3GUT),"g3(MGUT)"

       WRITE(16,907) "BLOCK GUTYU Q=",MGUT," # (GUT SCALE)"
       WRITE(16,903) 3,3,HTGUT,"HTOP(MGUT)"
       WRITE(16,907) "BLOCK GUTYD Q=",MGUT," # (GUT SCALE)"
       WRITE(16,903) 3,3,HBGUT,"HBOT(MGUT)"
       WRITE(16,907) "BLOCK GUTYE Q=",MGUT," # (GUT SCALE)"
       WRITE(16,903) 3,3,HLGUT,"HTAU(MGUT)"

       WRITE(16,899) "# "
       WRITE(16,899) "# NMSSM SPECIFIC COUPLINGS AT THE GUT SCALE"
       WRITE(16,907) "BLOCK GUTNMSSMRUN Q=",MGUT," # (GUT SCALE)"
       WRITE(16,901) 1,LGUT,"LAMBDA(MGUT)"
       WRITE(16,901) 2,KGUT,"KAPPA(MGUT)"
       WRITE(16,901) 13,LPPGUT,"LPP(MGUT)"
       WRITE(16,901) 14,LTTGUT,"LTT(MGUT)"
       WRITE(16,901) 15,LUGUT,"LU(MGUT)"
       WRITE(16,901) 16,LDGUT,"LD(MGUT)"
       WRITE(16,901) 17,LTGUT,"LT(MGUT)"
       WRITE(16,901) 18,LBGUT,"LB(MGUT)"
       WRITE(16,901) 19,LLGUT,"LL(MGUT)"

      ELSE

       WRITE(16,899)
     .     "# GAUGE AND YUKAWA COUPLINGS AT THE LANDAU SINGULARITY"
       WRITE(16,907) "BLOCK LANGAUGE MLANDAU=",MGUT," # (LANDAU SCALE)"
       WRITE(16,901) 1,DSQRT(5d0/3d0*G1GUT),
     .        "g1(MLANDAU), (GUT normalization)"
       WRITE(16,901) 2,DSQRT(G2GUT),"g2(MLANDAU)"
       WRITE(16,901) 3,DSQRT(G3GUT),"g3(MLANDAU)"

       WRITE(16,907) "BLOCK LANYU MLANDAU=",MGUT," # (MLANDAU)"
       WRITE(16,903) 3,3,HTGUT,"HTOP(MLANDAU)"
       WRITE(16,907) "BLOCK LANYD MLANDAU=",MGUT," # (MLANDAU)"
       WRITE(16,903) 3,3,HBGUT,"HBOT(MLANDAU)"
       WRITE(16,907) "BLOCK LANYE MLANDAU=",MGUT," # (MLANDAU)"
       WRITE(16,903) 3,3,HLGUT,"HTAU(MLANDAU)"

       WRITE(16,899) "# "
       WRITE(16,899) "# NMSSM SPECIFIC PARAMETERS AT THE LANDAU SCALE"
       WRITE(16,907) "BLOCK LANNMSSMRUN MLANDAU=",MGUT," # (MLANDAU)"
       WRITE(16,901) 61,LGUT,"LAMBDA(MLANDAU)"
       WRITE(16,901) 62,KGUT,"KAPPA(MLANDAU)"
       WRITE(16,901) 13,LPPGUT,"LPP(MLANDAU)"
       WRITE(16,901) 14,LTTGUT,"LTT(MLANDAU)"
       WRITE(16,901) 15,LUGUT,"LU(MLANDAU)"
       WRITE(16,901) 16,LDGUT,"LD(MLANDAU)"
       WRITE(16,901) 17,LTGUT,"LT(MLANDAU)"
       WRITE(16,901) 18,LBGUT,"LB(MLANDAU)"
       WRITE(16,901) 19,LLGUT,"LL(MLANDAU)"
      ENDIF

      WRITE(16,899) "# "
      WRITE(16,899) "# FINE-TUNING parameter d(ln Mz^2)/d(ln PG^2)"
      WRITE(16,899) "# BLOCK FINETUNING"
      WRITE(16,901) 1,FTMES(1),"PM=MSUSYEFF"
      WRITE(16,901) 2,FTMES(2),"PM=MS"
      WRITE(16,901) 3,FTMES(3),"PM=ALAMBDA"
      WRITE(16,901) 4,FTMES(4),"PM=XIF"
      WRITE(16,901) 5,FTMES(5),"PM=XIS"
      WRITE(16,901) 6,FTMES(6),"PM=MUP"
      WRITE(16,901) 7,FTMES(7),"PM=MSP"
      WRITE(16,901) 8,FTMES(8),"PM=LAMBDA"
      WRITE(16,901) 9,FTMES(9),"PM=KAPPA"
      WRITE(16,901) 10,FTMES(10),"PM=HTOP"
      WRITE(16,901) 11,FTMES(11),"PM=MMES"
      WRITE(16,901) 12,FTMES(12),"PM=LPP"
      WRITE(16,901) 13,FTMES(13),"PM=LTT"
      WRITE(16,901) 14,FTMES(14),"PM=LU"
      WRITE(16,901) 15,FTMES(15),"PM=LD"
      WRITE(16,901) 16,FTMES(16),"PM=LT"
      WRITE(16,901) 17,FTMES(17),"PM=LB"
      WRITE(16,901) 18,FTMES(18),"PM=LL"
      WRITE(16,901) 19,FTMES(19),"PM=G1"
      WRITE(16,901) 20,FTMES(20),"PM=G2"
      WRITE(16,901) 21,FTMES(21),"PM=G3"
      WRITE(16,901) NMES+1,FTMES(NMES+1),"MAX"
      WRITE(16,914) NMES+2,INT(FTMES(NMES+2)),"IMAX"
...
*  From IF(OUTFLAG.NE.1)
     ...
     . 'BR(t -> ~t_2 ~chi_50)'
      ...
      WRITE(17,900) 2,"6.0.0      # Version number"
      IF(PROB(30).GT.0d0)
     ...
     . WRITE(17,900) 3,"# Problem in micrOMEGAs"
      IF(IFAIL.EQ.0.OR.IFAIL.GE.10)THEN
        IF(OMGFLAG.NE.0)CALL printRelDen(17)
      ELSE
