...
************************************************************************
      ...
      CHARACTER(200) PRE,SUF,IFILE,OFILE,EFILE

      INTEGER NPROB,NPAR
      PARAMETER (NPROB=88,NPAR=25)
      INTEGER IFAIL,I
      ...
      COMMON/CPVFILES/IFILE,OFILE,EFILE
...
*********************************************************************
     ...
     .     AMU_CPV
      ...
      WRITE(16,930) 2,"6.0.0      # Version number"

      IF(DABS(MGL_CPV).LT.1d3 .AND. MGL_CPV.NE.0d0)
     . WRITE(16,930) 3,"# Gluino mass < 1 TeV"
      IF(MIN(dsqrt(MSU2P(1)),dsqrt(MSU2P(2)),
     .       dsqrt(MSD2P(1)),dsqrt(MSD2P(2))).LT.1d3)
     . WRITE(16,930) 3,"# First generation squark masses < 1 TeV"
      IF(PROB(1).NE.0d0)
     ...
     . WRITE(16,930) 3,"# Excluded by ee -> hZ, h -> 2photons"
      IF(PROB(10).NE.0d0)
     . WRITE(16,930) 3,"# Excluded by ee -> hZ, h -> h -> 4bs"
      IF(PROB(11).NE.0d0 .OR. PROB(41).NE.0d0)
     . WRITE(16,930) 3,"# Excluded by ee -> hZ, h -> hh -> 4taus"
      IF(PROB(12).NE.0d0)
     . WRITE(16,930) 3,"# Excluded by ee -> hZ, h -> hh -> 2bs 2taus"
      IF(PROB(13).NE.0d0)
     . WRITE(16,930) 3,"# Excluded by ee -> Z -> hh (Z width)"
      IF(PROB(14).NE.0d0)
     . WRITE(16,930) 3,"# Excluded by ee -> hh -> 4bs"
      IF(PROB(15).NE.0d0)
     . WRITE(16,930) 3,"# Excluded by ee -> hh -> 4taus"
      IF(PROB(16).NE.0d0)
     . WRITE(16,930) 3,"# Excluded by ee -> hh -> 2bs 2taus"
      IF(PROB(17).NE.0d0)
     . WRITE(16,930) 3,"# Excluded by ee -> hh -> hhh -> 6bs"
      IF(PROB(18).NE.0d0)
     . WRITE(16,930) 3,"# Excluded by ee -> hh -> hhh -> 6taus"
      IF(PROB(19).NE.0d0)
     . WRITE(16,930) 3,"# Excluded by ee -> hZ, h -> hh, h -> light
     . pair"
      IF(PROB(20).NE.0d0)
     ...
     . "# Excluded by top -> b H+, H+ -> W+ A1, A1 -> 2taus"
      IF(PROB(45).NE.0d0)
     . WRITE(16,930) 3,"# Excluded by t -> bH+ (ATLAS)"
      IF(PROB(46).NE.0d0)
     ...
     ."# Excluded by H_SM->AA->4leptons/2lept.+2b (ATLAS+CMS)"
      IF(PROB(53).NE.0d0)
     . WRITE(16,930) 3,"# Excluded by ggF->H/A->gamgam (ATLAS)"
      IF(PROB(54).NE.0d0)
     . WRITE(16,930) 3,"# Excluded by EDMs"
      IF(PROB(55).NE.0d0)
     ...
     . WRITE(16,930) 3,"# b -> c tau nu more than 2 sigma away (as SM)"
      IF(PROB(63).NE.0d0)
     . WRITE(16,930) 3,"# Excluded by H_SM->AA->4gam (ATLAS+CMS)"
      IF(PROB(67).NE.0d0)
     . WRITE(16,930) 3,"# k_W/Z(H_SM) more than 2 sigma away"
      IF(PROB(68).NE.0d0)
     . WRITE(16,930) 3,"# k_top(H_SM) more than 2 sigma away"
      IF(PROB(69).NE.0d0)
     . WRITE(16,930) 3,"# k_bot(H_SM) more than 2 sigma away"
      IF(PROB(70).NE.0d0)
     . WRITE(16,930) 3,"# k_glu(H_SM) more than 2 sigma away"
      IF(PROB(71).NE.0d0)
     . WRITE(16,930) 3,"# k_gam(H_SM) more than 2 sigma away"
      IF(PROB(72).NE.0d0)
     . WRITE(16,930) 3,"# k_tau(H_SM) more than 2 sigma away"
      IF(PROB(73).NE.0d0)
     . WRITE(16,930) 3,"# B_bsm(H_SM) more than 2 sigma away"
      IF(PROB(74).NE.0d0)
     . WRITE(16,930) 3,"# excluded by H_SM->Z+A->had (ATLAS)"
      IF(PROB(75).NE.0d0)
     . WRITE(16,930) 3,"# excluded by H_SM->Z+A->2mu (ATLAS)"
      IF(PROB(76).NE.0d0)
     . WRITE(16,930) 3,"# excluded by H_SM->Z+A->2mu (CMS)"
      IF(PROB(75).NE.0d0)
     . WRITE(16,930) 3,"# excluded by H_SM->Z+A->2mu (ATLAS)"
      IF(PROB(76).NE.0d0)
     . WRITE(16,930) 3,"# excluded by H_SM->Z+A->2mu (CMS)"
     ...
     . WRITE(16,930) 3,"# excluded by H/A->toptop (CMS)"
      IF(PROB(78).NE.0d0)
     . WRITE(16,930) 3,"# excluded by A->Z+H_SM->bb (CMS)"
      IF(PROB(79).NE.0d0)
     . WRITE(16,930) 3,"# excluded by A->Z+H_SM->bb (ATLAS)"
      IF(PROB(80).NE.0d0)
     . WRITE(16,930) 3,"# excluded by H/A->Z+A/H (CMS)"
      IF(PROB(81).NE.0d0)
     . WRITE(16,930) 3,"# excluded by H/A->Z+A/H (ATLAS)"
      IF(PROB(82).NE.0d0)
     . WRITE(16,930) 3,"# excluded by H/A->HSM+H/A->2b2tau (CMS)"
      IF(PROB(83).NE.0d0)
     . WRITE(16,930) 3,"# excluded by H/A->HSM+H/A->4b (CMS)"
      IF(PROB(84).NE.0d0)
     . WRITE(16,930) 3,"# excluded by H->HSM+HSM->2b2gam (ATLAS)"
      IF(PROB(85).NE.0d0)
     . WRITE(16,930) 3,"# excluded by H->HSM+HSM (ATLAS)"
      IF(PROB(86).NE.0d0)
     . WRITE(16,930) 3,"# excluded by H->HSM+HSM (CMS)"
     ...
     . WRITE(16,930) 4,"# Negative sfermion mass squared"
      ...
      WRITE(16,921) 5,2,"0: without CP-Violation, 2: with CP-Violation"
      ...
      WRITE(16,901) 1,REALP(3),"RE(M1)"
      WRITE(16,901) 2,REALP(4),"RE(M2)"
      WRITE(16,901) 3,REALP(5),"RE(M3)"
      WRITE(16,901) 11,REALP(6),"RE(ATOP)"
      WRITE(16,901) 12,REALP(7),"RE(ABOTTOM)"
      WRITE(16,901) 13,REALP(8),"RE(ATAU)"
      WRITE(16,901) 16,PAR(25),"RE(AMUON)"
      ...
      WRITE(16,901) 61,REALP(1),"RE(LAMBDA)"
      IF(PAR(2).NE.0d0)THEN
       WRITE(16,901) 62,REALP(2),"RE(KAPPA)"
      ENDIF
      IF(MOD(MAFLAG,3).NE.1)THEN
       WRITE(16,901) 63,PAR(5),"RE(ALAMBDA)"
      ELSE
       WRITE(16,920) 63,PAR(5),"RE(ALAMBDA)"
      ENDIF
      IF(PAR(2).NE.0d0)THEN
       IF(MAFLAG/3.NE.1)THEN
        WRITE(16,901) 64,PAR(6),"RE(AKAPPA)"
       ELSE
        WRITE(16,920) 64,PAR(6),"RE(AKAPPA)"
       ENDIF
      ENDIF
      WRITE(16,901) 65,REALP(14),"RE(MUEFF)"
      IF(MOD(MAFLAG,3).NE.2)THEN
       IF(REALP(9).NE.0d0)
     .  WRITE(16,901) 66,RXIF,"RE(XIF)"
      ELSE
       WRITE(16,920) 66,RXIF,"RE(XIF)"
      ENDIF
      IF(MAFLAG/3.NE.2)THEN
       IF(REALP(10).NE.0d0)
     .  WRITE(16,901) 67,RXIS,"RE(XIS)"
      ELSE
       WRITE(16,920) 67,RXIS,"RE(XIS)"
      ENDIF
      IF(REALP(11).NE.0d0)
     . WRITE(16,901) 68,REALP(11),"RE(MUP)"
      IF(REALP(12).NE.0d0)
     . WRITE(16,901) 69,REALP(12),"RE(MSP)"
      IF(REALP(13).NE.0d0)
     .  WRITE(16,901) 72,REALP(13),"RE(M3H)"
      ...
      WRITE(16,899) "BLOCK IMEXTPAR"
      WRITE(16,901) 1,IMAGP(3),"IM(M1)"
      WRITE(16,901) 2,IMAGP(4),"IM(M2)"
      WRITE(16,901) 3,IMAGP(5),"IM(M3)"
      WRITE(16,901) 11,IMAGP(6),"IM(ATOP)"
      WRITE(16,901) 12,IMAGP(7),"IM(ABOTTOM)"
      WRITE(16,901) 13,IMAGP(8),"IM(ATAU)"
      WRITE(16,901) 61,IMAGP(1),"IM(LAMBDA)"
      WRITE(16,901) 62,IMAGP(2),"IM(KAPPA)"
      WRITE(16,920) 63,IALQ2,"IM(ALAMBDA)"
      WRITE(16,920) 64,IAKQ2,"IM(AKAPPA)"
      WRITE(16,920) 65,IMAGP(14),"IM(MUEFF)"
      IF(IMAGP(9).NE.0d0)
     . WRITE(16,901) 66,IMAGP(9),"IM(XIF)"
      IF(PAR(2).NE.0d0)THEN
       IF(IXISQ2.NE.0d0)
     .  WRITE(16,901) 67,IXISQ2,"IM(XIS)"
      ELSE
       WRITE(16,920) 67,IXISQ2,"IM(XIS)"
      ENDIF
      IF(IMAGP(11).NE.0d0)
     . WRITE(16,901) 68,IMAGP(11),"IM(MUP)"
      IF(IMAGP(12).NE.0d0)
     . WRITE(16,901) 69,IMAGP(12),"IM(MSP)"
      IF(IMAGP(13).NE.0d0)
     .  WRITE(16,901) 72,IMAGP(13),"IM(M3H)"

      WRITE(16,899) "BLOCK ABS.VALUES mod. SIGN(Real part)"
      ...
      IF(PAR(5).NE.0d0)THEN
       WRITE(16,901) 63,DSQRT(PAR(5)**2+IALQ2**2)*PAR(5)/DABS(PAR(5)),
     . "+/-|ALAMBDA|"
      ELSE
       WRITE(16,901) 63,DABS(IALQ2),"+/-|ALAMBDA|"
      ENDIF
      IF(PAR(6).NE.0d0)THEN
       WRITE(16,901) 64,DSQRT(PAR(6)**2+IAKQ2**2)*PAR(6)/DABS(PAR(6)),
     . "+/-|AKAPPA|"
      ELSE
       WRITE(16,901) 64,DABS(IAKQ2),"+/-|AKAPPA|"
      ENDIF
      WRITE(16,901) 65,PAR(4),"+/-|MUEFF|"
      IF(RXIF.NE.0d0)THEN
       WRITE(16,901) 66,DSQRT(RXIF**2+IMAGP(9)**2)*RXIF/DABS(RXIF),
     . "+/-|XIF|"
      ELSEIF(IMAGP(9).NE.0d0)THEN
       WRITE(16,901) 66,DABS(IMAGP(9)),"+/-|XIF|"
      ENDIF
      IF(RXIS.NE.0d0)THEN
       WRITE(16,901) 67,DSQRT(RXIS**2+IXISQ2**2)*RXIS/DABS(RXIS),
     . "+/-|XIS|"
      ELSEIF(IXISQ2.NE.0d0)THEN
       WRITE(16,901) 67,DABS(IXISQ2),"+/-|XIS|"
      ENDIF
      IF(MUPSUSY.NE.0d0)
     ...
     . WRITE(16,901) 72,M3HSUSY,"+/-|M3H|"
      ...
      WRITE(16,899) "BLOCK PHASES (-Pi/2 < PHI < Pi/2)"
      WRITE(16,901) 1,PHASES(3),"PHI(M1)"
      WRITE(16,901) 2,PHASES(4),"PHI(M2)"
      WRITE(16,901) 3,PHASES(5),"PHI(M3)"
      WRITE(16,901) 11,PHASES(6),"PHI(ATOP)"
      WRITE(16,901) 12,PHASES(7),"PHI(ABOTTOM)"
      WRITE(16,901) 13,PHASES(8),"PHI(ATAU)"
      WRITE(16,901) 61,PHASES(1),"PHI(LAMBDA)"
      WRITE(16,901) 62,PHASES(2),"PHI(KAPPA)"
      IF(PAR(5).NE.0d0)THEN
       WRITE(16,901) 63,DATAN(IALQ2/PAR(5)),"PHI(ALAMBDA)"
      ELSEIF(IALQ2.NE.0d0)THEN
       WRITE(16,901) 63,SIGN(PI/2d0,IALQ2),"PHI(ALAMBDA)"
      ELSE
       WRITE(16,901) 63,0d0,"PHI(ALAMBDA)"
      ENDIF
      IF(PAR(6).NE.0d0)THEN
       WRITE(16,901) 64,DATAN(IAKQ2/PAR(6)),"PHI(AKAPPA)"
      ELSEIF(IAKQ2.NE.0d0)THEN
       WRITE(16,901) 64,SIGN(PI/2d0,IAKQ2),"PHI(AKAPPA)"
      ELSE
       WRITE(16,901) 64,0d0,"PHI(AKAPPA)"
      ENDIF
      WRITE(16,901) 65,DATAN(IMAGP(14)/REALP(14)),"PHI(MUEFF)"
      IF(RXIF.NE.0d0)THEN
       WRITE(16,901) 66,DATAN(IMAGP(9)/RXIF),"PHI(XIF)"
      ELSEIF(IMAGP(9).NE.0d0)THEN
       WRITE(16,901) 66,SIGN(PI/2d0,IMAGP(9)),"PHI(XIF)"
      ENDIF
      IF(RXIS.NE.0d0)THEN
       WRITE(16,901) 67,DATAN(IXISQ2/RXIS),"PHI(XIS)"
      ELSEIF(IXISQ2.NE.0d0)THEN
       WRITE(16,901) 67,SIGN(PI/2d0,IXISQ2),"PHI(XIS)"
      ENDIF
      IF(MUPSUSY.NE.0d0)
     . WRITE(16,901) 68,PHASES(15),"PHI(MUP)"
      IF(MSPSUSY.NE.0d0)
     . WRITE(16,901) 69,PHASES(13),"PHI(MSP)"
      IF(M3HSUSY.NE.0d0)
     . WRITE(16,901) 72,PHASES(16),"PHI(M3H)"
      ...
      WRITE(16,902) 25,DSQRT(MH0T(1)),"lightest neutral CPV_scalar"
      WRITE(16,902) 35,DSQRT(MH0T(2)),"second neutral CPV_scalar"
      WRITE(16,902) 45,DSQRT(MH0T(3)),"third neutral CPV_scalar"
      WRITE(16,902) 36,DSQRT(MH0T(4)),"fourth neutral CPV_scalar"
      WRITE(16,902) 46,DSQRT(MH0T(5)),"fifth neutral CPV_scalar"
      WRITE(16,902) 37,DSQRT(MHC_CPV),"charged Higgs"

      WRITE(16,902) 1000001,dsqrt(MSD2P(1))," ~d_L"
      WRITE(16,902) 2000001,dsqrt(MSD2P(2))," ~d_R"
      WRITE(16,902) 1000002,dsqrt(MSU2P(1))," ~u_L"
      WRITE(16,902) 2000002,dsqrt(MSU2P(2))," ~u_R"
      WRITE(16,902) 1000003,dsqrt(MSD2P(1))," ~s_L"
      WRITE(16,902) 2000003,dsqrt(MSD2P(2))," ~s_R"
      WRITE(16,902) 1000004,dsqrt(MSU2P(1))," ~c_L"
      WRITE(16,902) 2000004,dsqrt(MSU2P(2))," ~c_R"
      WRITE(16,902) 1000006,dsqrt(MSB2P(1))," ~b_1"
      WRITE(16,902) 2000006,dsqrt(MSB2P(2))," ~b_2"
      WRITE(16,902) 1000006,dsqrt(MST2P(1))," ~t_1"
      WRITE(16,902) 2000006,dsqrt(MST2P(2))," ~t_2"

      WRITE(16,902) 1000011,dsqrt(MSE2_CPV(1))," ~e_L"
      WRITE(16,902) 2000011,dsqrt(MSE2_CPV(2))," ~e_R"
      WRITE(16,902) 1000012,dsqrt(MSNE2_CPV)," ~nue_L"
      WRITE(16,902) 1000013,dsqrt(MSE2_CPV(1))," ~mu_L"
      WRITE(16,902) 2000013,dsqrt(MSE2_CPV(2))," ~mu_R"
      WRITE(16,902) 1000014,dsqrt(MSNE2_CPV)," ~numu_L"
      WRITE(16,902) 1000015,DSQRT(MSL2_CPV(1))," ~tau_1"
      WRITE(16,902) 2000015,DSQRT(MSL2_CPV(2))," ~tau_2"
      WRITE(16,902) 1000016,DSQRT(MSNT2_CPV)," ~nutau_L"
      WRITE(16,902) 1000021,MGL_CPV," ~g"
      WRITE(16,902) 1000022,DSQRT(MNEU_CPV(1)),"neutralino(1)"
      WRITE(16,902) 1000023,DSQRT(MNEU_CPV(2)),"neutralino(2)"
      WRITE(16,902) 1000025,DSQRT(MNEU_CPV(3)),"neutralino(3)"
      WRITE(16,902) 1000035,DSQRT(MNEU_CPV(4)),"neutralino(4)"
      WRITE(16,902) 1000045,DSQRT(MNEU_CPV(5)),"neutralino(5)"
      WRITE(16,902) 1000024,DSQRT(MCH2(1)),"chargino(1)"
      WRITE(16,902) 1000037,DSQRT(MCH2(2)),"chargino(2)"
      WRITE(16,899) "# "
      ...
      WRITE(16,899) "# "
      WRITE(16,899) "# EDMs:"
      WRITE(16,899) "# dEe < 1E-28 e.cm (Thorium exp.)"
      WRITE(16,907) "# ",dEe,"   dEe"
      WRITE(16,907) "# ",dEemin,"   |dEemin|: |dEe| - Theor.Err."
      WRITE(16,899) "# dETl < 1.3E-24 e.cm (Thalium exp.)"
      WRITE(16,907) "# ",dETl,"   dETl"
      WRITE(16,907) "# ",dETlmin,"   |dETlmin|: |dETl| - Theor.Err."
      WRITE(16,899) "# dEn < 3E-26 e.cm (neutron exp.)"
      WRITE(16,907) "# ",dEnCQM,"   dEnCQM"
      WRITE(16,907) "# ",dEnCQMmin,
     . "   |dEnCQMmin|: |dEnCQM| - Theor.Err."
      WRITE(16,907) "# ",dEnPQM,"   dEnPQM"
      WRITE(16,907) "# ",dEnPQMmin,
     . "   |dEnPQMmin|: |dEnPQM| - Theor.Err."
      WRITE(16,907) "# ",dEnQSR,"   dEnQSR"
      WRITE(16,907) "# ",dEnQSRmin,
     . "   |dEnQSRmin|: |dEnQSR| - Theor.Err."
      WRITE(16,899) "# dEHg < 3.1E-29 e.cm (Mercury exp.)"
      WRITE(16,907) "# ",dEHg,"   dEHg"
      WRITE(16,907) "# ",dEHgmin,"   |dEHgmin|: |dEHg| - Theor.Err."
      WRITE(16,899) "# "
...
*  From IF(OUTFLAG.NE.1)
     ...
     .    " # (STOP/SBOTTOM MASSES)"
      ...
      WRITE(16,899) "# "
      WRITE(16,899) "# 5*5 Higgs mixing"
      WRITE(16,899) "BLOCK CVNMHMIX"
      WRITE(16,903) 1,1,XH0(1,2),"S_(1,1)"
      WRITE(16,903) 1,2,XH0(1,1),"S_(1,2)"
      WRITE(16,903) 1,3,XH0(1,3),"S_(1,3)"
      WRITE(16,903) 1,4,XH0(1,4),"S_(1,4)"
      WRITE(16,903) 1,5,XH0(1,5),"S_(1,5)"

      WRITE(16,903) 2,1,XH0(2,2),"S_(2,1)"
      WRITE(16,903) 2,2,XH0(2,1),"S_(2,2)"
      WRITE(16,903) 2,3,XH0(2,3),"S_(2,3)"
      WRITE(16,903) 2,4,XH0(2,4),"S_(2,4)"
      WRITE(16,903) 2,5,XH0(2,5),"S_(2,5)"

      WRITE(16,903) 3,1,XH0(3,2),"S_(3,1)"
      WRITE(16,903) 3,2,XH0(3,1),"S_(3,2)"
      WRITE(16,903) 3,3,XH0(3,3),"S_(3,3)"
      WRITE(16,903) 3,4,XH0(3,4),"S_(3,4)"
      WRITE(16,903) 3,5,XH0(3,5),"S_(3,5)"

      WRITE(16,903) 4,1,XH0(4,2),"S_(4,1)"
      WRITE(16,903) 4,2,XH0(4,1),"S_(4,2)"
      WRITE(16,903) 4,3,XH0(4,3),"S_(4,3)"
      WRITE(16,903) 4,4,XH0(4,4),"S_(4,4)"
      WRITE(16,903) 4,5,XH0(4,5),"S_(4,5)"

      WRITE(16,903) 5,1,XH0(5,2),"S_(5,1)"
      WRITE(16,903) 5,2,XH0(5,1),"S_(5,2)"
      WRITE(16,903) 5,3,XH0(5,3),"S_(5,3)"
      WRITE(16,903) 5,4,XH0(5,4),"S_(5,4)"
      WRITE(16,903) 5,5,XH0(5,5),"S_(5,5)"

      WRITE(16,899) "# "
      WRITE(16,899) "# 3rd generation sfermion mixing"
      WRITE(16,899) 
     .    "BLOCK STOPMIX  # Real part of the Stop mixing matrix"
      WRITE(16,903) 1,1,UT(1,1,1),"UT(1,1,1)"
      WRITE(16,903) 1,2,UT(1,2,1),"UT(1,2,1)"
      WRITE(16,903) 2,1,UT(2,1,1),"UT(2,1,1)"
      WRITE(16,903) 2,2,UT(2,2,1),"UT(2,2,1)"

      WRITE(16,899) 
     .    "BLOCK IMSTOPMIX  # Imag. part of the Stop mixing matrix"
      WRITE(16,903) 1,1,UT(1,1,2),"UT(1,1,2)"
      WRITE(16,903) 1,2,UT(1,2,2),"UT(1,2,2)"
      WRITE(16,903) 2,1,UT(2,1,2),"UT(2,1,2)"
      WRITE(16,903) 2,2,UT(2,2,2),"UT(2,2,2)"

      WRITE(16,899) 
     .     "BLOCK SBOTMIX  # Real part of the Sbottom mixing matrix"
      WRITE(16,903) 1,1,UB(1,1,1),"UB(1,1,1)"
      WRITE(16,903) 1,2,UB(1,2,1),"UB(1,2,1)"
      WRITE(16,903) 2,1,UB(2,1,1),"UB(2,1,1)"
      WRITE(16,903) 2,2,UB(2,2,1),"UB(2,2,1)"

      WRITE(16,899) 
     .    "BLOCK IMSBOTMIX  # Imag. part of the Sbottom mixing matrix"
      WRITE(16,903) 1,1,UB(1,1,2),"UB(1,1,2)"
      WRITE(16,903) 1,2,UB(1,2,2),"UB(1,2,2)"
      WRITE(16,903) 2,1,UB(2,1,2),"UB(2,1,2)"
      WRITE(16,903) 2,2,UB(2,2,2),"UB(2,2,2)"

      WRITE(16,899) 
     .    "BLOCK STAUMIX  # Real part of the Stau mixing matrix"
      WRITE(16,903) 1,1,UTAU(1,1,1),"UTAU(1,1,1)"
      WRITE(16,903) 1,2,UTAU(1,2,1),"UTAU(1,2,1)"
      WRITE(16,903) 2,1,UTAU(2,1,1),"UTAU(2,1,1)"
      WRITE(16,903) 2,2,UTAU(2,2,1),"UTAU(2,2,1)"

      WRITE(16,899) 
     .    "BLOCK STAUMIX  # Imag. part of the Stau mixing matrix"
      WRITE(16,903) 1,1,UTAU(1,1,2),"UTAU(1,1,2)"
      WRITE(16,903) 1,2,UTAU(1,2,2),"UTAU(1,2,2)"
      WRITE(16,903) 2,1,UTAU(2,1,2),"UTAU(2,1,2)"
      WRITE(16,903) 2,2,UTAU(2,2,2),"UTAU(2,2,2)"

      WRITE(16,899) "# "
      WRITE(16,899) "# Gaugino-Higgsino mixing"
      WRITE(16,899) 
     .   "BLOCK RNMNMIX  # Real part of the Neutralino Mixing Matrix"
      WRITE(16,903) 1,1,NEU_CPV(1,1,1),"RE(N)_(1,1)"
      WRITE(16,903) 1,2,NEU_CPV(1,2,1),"RE(N)_(1,2)"
      WRITE(16,903) 1,3,NEU_CPV(1,4,1),"RE(N)_(1,3)"
      WRITE(16,903) 1,4,NEU_CPV(1,3,1),"RE(N)_(1,4)"
      WRITE(16,903) 1,5,NEU_CPV(1,5,1),"RE(N)_(1,5)"
      WRITE(16,903) 2,1,NEU_CPV(2,1,1),"RE(N)_(2,1)"
      WRITE(16,903) 2,2,NEU_CPV(2,2,1),"RE(N)_(2,2)"
      WRITE(16,903) 2,3,NEU_CPV(2,4,1),"RE(N)_(2,3)"
      WRITE(16,903) 2,4,NEU_CPV(2,3,1),"RE(N)_(2,4)"
      WRITE(16,903) 2,5,NEU_CPV(2,5,1),"RE(N)_(2,5)"
      WRITE(16,903) 3,1,NEU_CPV(3,1,1),"RE(N)_(3,1)"
      WRITE(16,903) 3,2,NEU_CPV(3,2,1),"RE(N)_(3,2)"
      WRITE(16,903) 3,3,NEU_CPV(3,4,1),"RE(N)_(3,3)"
      WRITE(16,903) 3,4,NEU_CPV(3,3,1),"RE(N)_(3,4)"
      WRITE(16,903) 3,5,NEU_CPV(3,5,1),"RE(N)_(3,5)"
      WRITE(16,903) 4,1,NEU_CPV(4,1,1),"RE(N)_(4,1)"
      WRITE(16,903) 4,2,NEU_CPV(4,2,1),"RE(N)_(4,2)"
      WRITE(16,903) 4,3,NEU_CPV(4,4,1),"RE(N)_(4,3)"
      WRITE(16,903) 4,4,NEU_CPV(4,3,1),"RE(N)_(4,4)"
      WRITE(16,903) 4,5,NEU_CPV(4,5,1),"RE(N)_(4,5)"
      WRITE(16,903) 5,1,NEU_CPV(5,1,1),"RE(N)_(5,1)"
      WRITE(16,903) 5,2,NEU_CPV(5,2,1),"RE(N)_(5,2)"
      WRITE(16,903) 5,3,NEU_CPV(5,4,1),"RE(N)_(5,3)"
      WRITE(16,903) 5,4,NEU_CPV(5,3,1),"RE(N)_(5,4)"
      WRITE(16,903) 5,5,NEU_CPV(5,5,1),"RE(N)_(5,5)"

      WRITE(16,899) "# "
      WRITE(16,899) "# Gaugino-Higgsino mixing"
      WRITE(16,899) 
     .     "BLOCK INMNMIX  # Imag. part of the Neutralino Mixing Matrix"
      WRITE(16,903) 1,1,NEU_CPV(1,1,2),"IM(N)_(1,1)"
      WRITE(16,903) 1,2,NEU_CPV(1,2,2),"IM(N)_(1,2)"
      WRITE(16,903) 1,3,NEU_CPV(1,4,2),"IM(N)_(1,3)"
      WRITE(16,903) 1,4,NEU_CPV(1,3,2),"IM(N)_(1,4)"
      WRITE(16,903) 1,5,NEU_CPV(1,5,2),"IM(N)_(1,5)"
      WRITE(16,903) 2,1,NEU_CPV(2,1,2),"IM(N)_(2,1)"
      WRITE(16,903) 2,2,NEU_CPV(2,2,2),"IM(N)_(2,2)"
      WRITE(16,903) 2,3,NEU_CPV(2,4,2),"IM(N)_(2,3)"
      WRITE(16,903) 2,4,NEU_CPV(2,3,2),"IM(N)_(2,4)"
      WRITE(16,903) 2,5,NEU_CPV(2,5,2),"IM(N)_(2,5)"
      WRITE(16,903) 3,1,NEU_CPV(3,1,2),"IM(N)_(3,1)"
      WRITE(16,903) 3,2,NEU_CPV(3,2,2),"IM(N)_(3,2)"
      WRITE(16,903) 3,3,NEU_CPV(3,4,2),"IM(N)_(3,3)"
      WRITE(16,903) 3,4,NEU_CPV(3,3,2),"IM(N)_(3,4)"
      WRITE(16,903) 3,5,NEU_CPV(3,5,2),"IM(N)_(3,5)"
      WRITE(16,903) 4,1,NEU_CPV(4,1,2),"IM(N)_(4,1)"
      WRITE(16,903) 4,2,NEU_CPV(4,2,2),"IM(N)_(4,2)"
      WRITE(16,903) 4,3,NEU_CPV(4,4,2),"IM(N)_(4,3)"
      WRITE(16,903) 4,4,NEU_CPV(4,3,2),"IM(N)_(4,4)"
      WRITE(16,903) 4,5,NEU_CPV(4,5,2),"IM(N)_(4,5)"
      WRITE(16,903) 5,1,NEU_CPV(5,1,2),"IM(N)_(5,1)"
      WRITE(16,903) 5,2,NEU_CPV(5,2,2),"IM(N)_(5,2)"
      WRITE(16,903) 5,3,NEU_CPV(5,4,2),"IM(N)_(5,3)"
      WRITE(16,903) 5,4,NEU_CPV(5,3,2),"IM(N)_(5,4)"
      WRITE(16,903) 5,5,NEU_CPV(5,5,2),"IM(N)_(5,5)"

      WRITE(16,899) "# "
      WRITE(16,899) "BLOCK RUMIX  # Real Chargino U Mixing Matrix"
      WRITE(16,903) 1,1,U_CPV(1,1,1),"RE(U)_(1,1)"
      WRITE(16,903) 1,2,U_CPV(1,2,1),"RE(U)_(1,2)"
      WRITE(16,903) 2,1,U_CPV(2,1,1),"RE(U)_(2,1)"
      WRITE(16,903) 2,2,U_CPV(2,2,1),"RE(U)_(2,2)"

      WRITE(16,899) "# "
      WRITE(16,899) "BLOCK IUMIX  # Imag Chargino U Mixing Matrix"
      WRITE(16,903) 1,1,U_CPV(1,1,2),"IM(U)_(1,1)"
      WRITE(16,903) 1,2,U_CPV(1,2,2),"IM(U)_(1,2)"
      WRITE(16,903) 2,1,U_CPV(2,1,2),"IM(U)_(2,1)"
      WRITE(16,903) 2,2,U_CPV(2,2,2),"IM(U)_(2,2)"

      WRITE(16,899) "# "
      WRITE(16,899) "BLOCK RVMIX  # Real Chargino V Mixing Matrix"
      WRITE(16,903) 1,1,V_CPV(1,1,1),"RE(V)_(1,1)"
      WRITE(16,903) 1,2,V_CPV(1,2,1),"RE(V)_(1,2)"
      WRITE(16,903) 2,1,V_CPV(2,1,1),"RE(V)_(2,1)"
      WRITE(16,903) 2,2,V_CPV(2,2,1),"RE(V)_(2,2)"

      WRITE(16,899) "# "
      WRITE(16,899) "BLOCK IVMIX  # Imag Chargino V Mixing Matrix"
      WRITE(16,903) 1,1,V_CPV(1,1,2),"IM(V)_(1,1)"
      WRITE(16,903) 1,2,V_CPV(1,2,2),"IM(V)_(1,2)"
      WRITE(16,903) 2,1,V_CPV(2,1,2),"IM(V)_(2,1)"
      WRITE(16,903) 2,2,V_CPV(2,2,2),"IM(V)_(2,2)"
      WRITE(16,899) "# "
      ...
      WRITE(16,899) "# 0.827 < CU < 1.131 " ! top quark
      WRITE(16,899) "# 0.772 < CB < 1.081 " ! b quark
      WRITE(16,899) "# 0.842 < CL < 1.046 " ! taus
      WRITE(16,899) "# 0.966 < CV < 1.000 " ! electroweak couplings
      WRITE(16,899) "# 0.858 < CJ < 1.060 " ! gluons
      WRITE(16,899) "# 0.933 < CG < 1.100 " ! photons
      ...
      WRITE(16,899) "# H1, imag. parts:"
      WRITE(16,903) 1,1,CUP(1),"U-type fermions"
      WRITE(16,903) 1,2,CDP(1),"D-type fermions"
      WRITE(16,903) 1,3,CBP(1),"b-quarks"
      WRITE(16,903) 1,4,CLP(1),"taus"
      WRITE(16,903) 1,5,0d0,"W,Z bosons"
      WRITE(16,903) 1,6,CJP(1),"Gluons"
      WRITE(16,903) 1,7,CGP(1),"Photons"

      WRITE(16,899) "# H2"
      WRITE(16,903) 2,1,CU(2),"U-type fermions"
      WRITE(16,903) 2,2,CD(2),"D-type fermions"
      WRITE(16,903) 2,3,CB(2),"b-quarks"
      WRITE(16,903) 1,4,CL(2),"taus"
      WRITE(16,903) 2,5,CV(2),"W,Z bosons"
      WRITE(16,903) 2,6,CJ(2),"Gluons"
      WRITE(16,903) 2,7,CG(2),"Photons"
      WRITE(16,899) "# H2, imag. parts"
      WRITE(16,903) 2,1,CUP(2),"U-type fermions"
      WRITE(16,903) 2,2,CDP(2),"D-type fermions"
      WRITE(16,903) 2,3,CBP(2),"b-quarks"
      WRITE(16,903) 1,4,CLP(2),"taus"
      WRITE(16,903) 1,5,0d0,"W,Z bosons"
      WRITE(16,903) 2,6,CJP(2),"Gluons"
      WRITE(16,903) 2,7,CGP(2),"Photons"

      WRITE(16,899) "# H3"
      WRITE(16,903) 3,1,CU(3),"U-type fermions"
      WRITE(16,903) 3,2,CD(3),"D-type fermions"
      WRITE(16,903) 3,3,CB(3),"b-quarks"
      WRITE(16,903) 1,4,CL(3),"taus"
      WRITE(16,903) 3,5,CV(3),"W,Z bosons"
      WRITE(16,903) 3,6,CJ(3),"Gluons"
      WRITE(16,903) 3,7,CG(3),"Photons"
      WRITE(16,899) "# H3, imag. parts"
      WRITE(16,903) 3,1,CUP(3),"U-type fermions"
      WRITE(16,903) 3,2,CDP(3),"D-type fermions"
      WRITE(16,903) 3,3,CBP(3),"b-quarks"
      WRITE(16,903) 1,4,CLP(3),"taus"
      WRITE(16,903) 1,5,0d0,"W,Z bosons"
      WRITE(16,903) 3,6,CJP(3),"Gluons"
      WRITE(16,903) 3,7,CGP(3),"Photons"

      WRITE(16,899) "# H4"
      WRITE(16,903) 4,1,CU(4),"U-type fermions"
      WRITE(16,903) 4,2,CD(4),"D-type fermions"
      WRITE(16,903) 4,3,CB(4),"b-quarks"
      WRITE(16,903) 1,4,CL(4),"taus"
      WRITE(16,903) 4,5,CV(4),"W,Z bosons"
      WRITE(16,903) 4,6,CJ(4),"Gluons"
      WRITE(16,903) 4,7,CG(4),"Photons"
      WRITE(16,899) "# H4, imag. parts"
      WRITE(16,903) 4,1,CUP(4),"U-type fermions"
      WRITE(16,903) 4,2,CDP(4),"D-type fermions"
      WRITE(16,903) 4,3,CBP(4),"b-quarks"
      WRITE(16,903) 1,4,CLP(4),"taus"
      WRITE(16,903) 1,5,0d0,"W,Z bosons"
      WRITE(16,903) 4,6,CJP(4),"Gluons"
      WRITE(16,903) 4,7,CGP(4),"Photons"

      WRITE(16,899) "# H5"
      WRITE(16,903) 5,1,CU(5),"U-type fermions"
      WRITE(16,903) 5,2,CD(5),"D-type fermions"
      WRITE(16,903) 5,3,CB(5),"b-quarks"
      WRITE(16,903) 1,4,CL(5),"taus"
      WRITE(16,903) 5,5,CV(5),"W,Z bosons"
      WRITE(16,903) 5,6,CJ(5),"Gluons"
      WRITE(16,903) 5,7,CG(5),"Photons"
      WRITE(16,899) "# H5, imag. parts"
      WRITE(16,903) 5,1,CUP(5),"U-type fermions"
      WRITE(16,903) 5,2,CDP(5),"D-type fermions"
      WRITE(16,903) 5,3,CBP(5),"b-quarks"
      WRITE(16,903) 1,4,CLP(5),"taus"
      WRITE(16,903) 1,5,0d0,"W,Z bosons"
      WRITE(16,903) 5,6,CJP(5),"Gluons"
      WRITE(16,903) 5,7,CGP(5),"Photons"
      ...
      WRITE(16,901) 11,SIG_CPV(1,1),"VBF/VH -> H1 -> tautau"
      WRITE(16,901) 12,SIG_CPV(1,2),"ggF -> H1 -> tautau"
      WRITE(16,901) 13,SIG_CPV(1,3),"VBF/VH -> H1 -> bb"
      WRITE(16,901) 14,SIG_CPV(1,4),"ttH -> H1 -> bb"
      WRITE(16,901) 15,SIG_CPV(1,5),"VBF/VH -> H1 -> ZZ/WW"
      WRITE(16,901) 16,SIG_CPV(1,6),"ggF -> H1 -> ZZ/WW"
      WRITE(16,901) 17,SIG_CPV(1,7),"VBF/VH -> H1 -> gammagamma"
      WRITE(16,901) 18,SIG_CPV(1,8),"ggF -> H1 -> gammagamma"
      WRITE(16,901) 21,SIG_CPV(2,1),"VBF/VH -> H2 -> tautau"
      WRITE(16,901) 22,SIG_CPV(2,2),"ggF -> H2 -> tautau"
      WRITE(16,901) 23,SIG_CPV(2,3),"VBF/VH -> H2 -> bb"
      WRITE(16,901) 24,SIG_CPV(2,4),"ttH -> H2 -> bb"
      WRITE(16,901) 25,SIG_CPV(2,5),"VBF/VH -> H2 -> ZZ/WW"
      WRITE(16,901) 26,SIG_CPV(2,6),"ggF -> H2 -> ZZ/WW"
      WRITE(16,901) 27,SIG_CPV(2,7),"VBF/VH -> H2 -> gammagamma"
      WRITE(16,901) 28,SIG_CPV(2,8),"ggF -> H2 -> gammagamma"
      WRITE(16,901) 31,SIG_CPV(3,1),"VBF/VH -> H3 -> tautau"
      WRITE(16,901) 32,SIG_CPV(3,2),"ggF -> H3 -> tautau"
      WRITE(16,901) 33,SIG_CPV(3,3),"VBF/VH -> H3 -> bb"
      WRITE(16,901) 34,SIG_CPV(3,4),"ttH -> H3 -> bb"
      WRITE(16,901) 35,SIG_CPV(3,5),"VBF/VH -> H3 -> ZZ/WW"
      WRITE(16,901) 36,SIG_CPV(3,6),"ggF -> H3 -> ZZ/WW"
      WRITE(16,901) 37,SIG_CPV(3,7),"VBF/VH -> H3 -> gammagamma"
      WRITE(16,901) 38,SIG_CPV(3,8),"ggF -> H3 -> gammagamma"
      WRITE(16,901) 41,SIG_CPV(4,1),"VBF/VH -> H4 -> tautau"
      WRITE(16,901) 42,SIG_CPV(4,2),"ggF -> H4 -> tautau"
      WRITE(16,901) 43,SIG_CPV(4,3),"VBF/VH -> H4 -> bb"
      WRITE(16,901) 44,SIG_CPV(4,4),"ttH -> H4 -> bb"
      WRITE(16,901) 45,SIG_CPV(4,5),"VBF/VH -> H4 -> ZZ/WW"
      WRITE(16,901) 46,SIG_CPV(4,6),"ggF -> H4 -> ZZ/WW"
      WRITE(16,901) 47,SIG_CPV(4,7),"VBF/VH -> H4 -> gammagamma"
      WRITE(16,901) 48,SIG_CPV(4,8),"ggF -> H4 -> gammagamma"
      WRITE(16,901) 51,SIG_CPV(5,1),"VBF/VH -> H5 -> tautau"
      WRITE(16,901) 52,SIG_CPV(5,2),"ggF -> H5 -> tautau"
      WRITE(16,901) 53,SIG_CPV(5,3),"VBF/VH -> H5 -> bb"
      WRITE(16,901) 54,SIG_CPV(5,4),"ttH -> H5 -> bb"
      WRITE(16,901) 55,SIG_CPV(5,5),"VBF/VH -> H5 -> ZZ/WW"
      WRITE(16,901) 56,SIG_CPV(5,6),"ggF -> H5 -> ZZ/WW"
      WRITE(16,901) 57,SIG_CPV(5,7),"VBF/VH -> H5 -> gammagamma"
      WRITE(16,901) 58,SIG_CPV(5,8),"ggF -> H5 -> gammagamma"
      ...
      WRITE(16,900) 2,"6.0.0      # Version number"

      WRITE(16,899) "#           PDG          Width"
      WRITE(16,904) 25,WIDTH(1),"Lightest neutral Higgs scalar"
      IF(BRJJ(1).GT.0d0)
     ...
     .    "BR(H_1 -> ~nu_tau_L ~nu_taubar_L)"
      ...
      WRITE(16,904) 35,WIDTH(2),"2nd neutral Higgs scalar"
      IF(BRJJ(2).GT.0d0)
     ...
     .  WRITE(16,905) BRZG(2),2,23,22,"BR(H_2 -> Z gamma)"
      IF(BRHHH(2,1).GT.0d0)
     .  WRITE(16,905) BRHHH(2,1),2,25,25,"BR(H_2 -> H_1 H_1)"
      IF(BRHAZ(2,1).GT.0d0)
     .  WRITE(16,905) BRHAZ(2,1),2,23,25,"BR(H_2 -> H_1 Z)"
      IF(BRHCHC(2).GT.0d0)
     ...
     .  WRITE(16,905) BRZG(3),2,23,22,"BR(H_3 -> Z gamma)"
      IF(BRHHH(3,1).GT.0d0)
     .  WRITE(16,905) BRHHH(3,1),2,25,25,"BR(H_3 -> H_1 H_1)"
      IF(BRHHH(3,2).GT.0d0)
     .  WRITE(16,905) BRHHH(3,2),2,25,35,"BR(H_3 -> H_1 H_2)"
      IF(BRHHH(3,3).GT.0d0)
     .  WRITE(16,905) BRHHH(3,3),2,35,35,"BR(H_3 -> H_2 H_2)"
      IF(BRHAZ(3,1).GT.0d0)
     .  WRITE(16,905) BRHAZ(3,1),2,23,25,"BR(H_3 -> H_1 Z)"
      IF(BRHAZ(3,2).GT.0d0)
     .  WRITE(16,905) BRHAZ(3,2),2,23,35,"BR(H_3 -> H_2 Z)"
      IF(BRHCHC(3).GT.0d0)
     ...
     .    "BR(H_3 -> ~nu_tau_L ~nu_taubar_L)"
      ...
      WRITE(16,904) 36,WIDTH(4),"4th neutral Higgs scalar"
      IF(BRJJ(4).GT.0d0)
     .  WRITE(16,905) BRJJ(4),2,21,21,"BR(H_4 -> hadrons)"
      IF(BRMM(4).GT.0d0)
     .  WRITE(16,905) BRMM(4),2,13,-13,"BR(H_4 -> muon muon)"
      IF(BRLL(4).GT.0d0)
     .  WRITE(16,905) BRLL(4),2,15,-15,"BR(H_4 -> tau tau)"
      IF(BRCC(4).GT.0d0)
     .  WRITE(16,905) BRCC(4),2,4,-4,"BR(H_4 -> c cbar)"
      IF(BRBB(4).GT.0d0)
     .  WRITE(16,905) BRBB(4),2,5,-5,"BR(H_4 -> b bbar)"
      IF(BRTT(4).GT.0d0)
     .  WRITE(16,905) BRTT(4),2,6,-6,"BR(H_4 -> t tbar)"
      IF(BRGG(4).GT.0d0)
     .  WRITE(16,905) BRGG(4),2,22,22,"BR(H_4 -> gamma gamma)"
      IF(BRZG(4).GT.0d0)
     .  WRITE(16,905) BRZG(4),2,23,22,"BR(H_4 -> Z gamma)"
      IF(BRHHH(4,1).GT.0d0)
     .  WRITE(16,905) BRHHH(4,1),2,25,25,"BR(H_4 -> H_1 H_1)"
      IF(BRHHH(4,2).GT.0d0)
     .  WRITE(16,905) BRHHH(4,2),2,25,35,"BR(H_4 -> H_1 H_2)"
      IF(BRHHH(4,3).GT.0d0)
     .  WRITE(16,905) BRHHH(4,3),2,35,35,"BR(H_4 -> H_2 H_2)"
      IF(BRHHH(4,4).GT.0d0)
     .  WRITE(16,905) BRHHH(4,4),2,25,45,"BR(H_4 -> H_1 H_3)"
      IF(BRHHH(4,5).GT.0d0)
     .  WRITE(16,905) BRHHH(4,5),2,35,45,"BR(H_4 -> H_2 H_3)"
      IF(BRHHH(4,6).GT.0d0)
     .  WRITE(16,905) BRHHH(4,6),2,45,45,"BR(H_4 -> H_3 H_3)"
      IF(BRHAZ(4,1).GT.0d0)
     .  WRITE(16,905) BRHAZ(4,1),2,23,25,"BR(H_4 -> H_1 Z)"
      IF(BRHAZ(4,2).GT.0d0)
     .  WRITE(16,905) BRHAZ(4,2),2,23,35,"BR(H_4 -> H_2 Z)"
      IF(BRHAZ(4,3).GT.0d0)
     .  WRITE(16,905) BRHAZ(4,3),2,23,45,"BR(H_4 -> H_3 Z)"
      IF(BRHCHC(4).GT.0d0)
     .  WRITE(16,905) BRHCHC(4),2,37,-37,"BR(H_4 -> H+ H-)"
      IF(BRHCW(4).GT.0d0)
     .  WRITE(16,905) BRHCW(4),2,24,-37,"BR(H_4 -> W+ H-)"
      IF(BRHCW(4).GT.0d0)
     .  WRITE(16,905) BRHCW(4),2,-24,37,"BR(H_4 -> W- H+)"
     ...
     .    "BR(H_4 -> cha_2 cha_2bar)"
      IF(BRHSQ(4,1).GT.0d0)
     .  WRITE(16,905) BRHSQ(4,1),2,1000002,-1000002,
     .    "BR(H_4 -> ~u_L ~ubar_L)"
      IF(BRHSQ(4,1).GT.0d0)
     .  WRITE(16,905) BRHSQ(4,1),2,1000004,-1000004,
     .    "BR(H_4 -> ~c_L ~cbar_L)"
      IF(BRHSQ(4,2).GT.0d0)
     .  WRITE(16,905) BRHSQ(4,2),2,2000002,-2000002,
     .    "BR(H_4 -> ~u_R ~ubar_R)"
      IF(BRHSQ(4,2).GT.0d0)
     .  WRITE(16,905) BRHSQ(4,2),2,2000004,-2000004,
     .    "BR(H_4 -> ~c_R ~cbar_R)"
      IF(BRHSQ(4,3).GT.0d0)
     .  WRITE(16,905) BRHSQ(4,3),2,1000001,-1000001,
     .    "BR(H_4 -> ~d_L ~dbar_L)"
      IF(BRHSQ(4,3).GT.0d0)
     .  WRITE(16,905) BRHSQ(4,3),2,1000003,-1000003,
     .    "BR(H_4 -> ~s_L ~sbar_L)"
      IF(BRHSQ(4,4).GT.0d0)
     .  WRITE(16,905) BRHSQ(4,4),2,2000001,-2000001,
     .    "BR(H_4 -> ~d_R ~dbar_R)"
      IF(BRHSQ(4,4).GT.0d0)
     .  WRITE(16,905) BRHSQ(4,4),2,2000003,-2000003,
     .    "BR(H_4 -> ~s_R ~sbar_R)"
      IF(BRHSQ(4,5).GT.0d0)
     .  WRITE(16,905) BRHSQ(4,5),2,1000006,-1000006,
     .    "BR(H_4 -> ~t_1 ~tbar_1)"
      IF(BRHSQ(4,6).GT.0d0)
     .  WRITE(16,905) BRHSQ(4,6),2,2000006,-2000006,
     .    "BR(H_4 -> ~t_2 ~tbar_2)"
      IF(BRHSQ(4,7).GT.0d0)
     .  WRITE(16,905) BRHSQ(4,7),2,1000006,-2000006,
     .    "BR(H_4 -> ~t_1 ~tbar_2)"
      IF(BRHSQ(4,7).GT.0d0)
     .  WRITE(16,905) BRHSQ(4,7),2,2000006,-1000006,
     .    "BR(H_4 -> ~t_2 ~tbar_1)"
      IF(BRHSQ(4,8).GT.0d0)
     .  WRITE(16,905) BRHSQ(4,8),2,1000005,-1000005,
     .    "BR(H_4 -> ~b_1 ~bbar_1)"
      IF(BRHSQ(4,9).GT.0d0)
     .  WRITE(16,905) BRHSQ(4,9),2,2000005,-2000005,
     .    "BR(H_4 -> ~b_2 ~bbar_2)"
      IF(BRHSQ(4,10).GT.0d0)
     .  WRITE(16,905) BRHSQ(4,10),2,1000005,-2000005,
     .    "BR(H_4 -> ~b_1 ~bbar_2)"
      IF(BRHSQ(4,10).GT.0d0)
     .  WRITE(16,905) BRHSQ(4,10),2,2000005,-1000005,
     .    "BR(H_4 -> ~b_2 ~bbar_1)"
      IF(BRHSL(4,1).GT.0d0)
     .  WRITE(16,905) BRHSL(4,1),2,1000011,-1000011,
     .    "BR(H_4 -> ~e_L ~ebar_L)"
      IF(BRHSL(4,1).GT.0d0)
     .  WRITE(16,905) BRHSL(4,1),2,1000013,-1000013,
     .    "BR(H_4 -> ~mu_L ~mubar_L)"
      IF(BRHSL(4,2).GT.0d0)
     .  WRITE(16,905) BRHSL(4,2),2,2000011,-2000011,
     .    "BR(H_4 -> ~e_R ~ebar_R)"
      IF(BRHSL(4,2).GT.0d0)
     .  WRITE(16,905) BRHSL(4,2),2,2000013,-2000013,
     .    "BR(H_4 -> ~mu_R ~mubarRL)"
      IF(BRHSL(4,3).GT.0d0)
     .  WRITE(16,905) BRHSL(4,3),2,1000012,-1000012,
     .    "BR(H_4 -> ~nu_e_L ~nu_ebar_L)"
      IF(BRHSL(4,3).GT.0d0)
     .  WRITE(16,905) BRHSL(4,3),2,1000014,-1000014,
     .    "BR(H_4 -> ~nu_mu_L ~nu_mubar_L)"
      IF(BRHSL(4,4).GT.0d0)
     .  WRITE(16,905) BRHSL(4,4),2,1000015,-1000015,
     .    "BR(H_4 -> ~tau_1 ~taubar_1)"
      IF(BRHSL(4,5).GT.0d0)
     .  WRITE(16,905) BRHSL(4,5),2,2000015,-2000015,
     .    "BR(H_4 -> ~tau_2 ~taubar_2)"
      IF(BRHSL(4,6).GT.0d0)
     .  WRITE(16,905) BRHSL(4,6),2,1000015,-2000015,
     .    "BR(H_4 -> ~tau_1 ~taubar_2)"
      IF(BRHSL(4,6).GT.0d0)
     .  WRITE(16,905) BRHSL(4,6),2,2000015,-1000015,
     .    "BR(H_4 -> ~tau_2 ~taubar_1)"
      IF(BRHSL(4,7).GT.0d0)
     .  WRITE(16,905) BRHSL(4,7),2,1000016,-1000016,
     .    "BR(H_4 -> ~nu_tau_L ~nu_taubar_L)"

      WRITE(16,904) 46,WIDTH(5),"5th neutral Higgs scalar"
      IF(BRJJ(5).GT.0d0)
     .  WRITE(16,905) BRJJ(5),2,21,21,"BR(H_5 -> hadrons)"
      IF(BRMM(5).GT.0d0)
     .  WRITE(16,905) BRMM(5),2,13,-13,"BR(H_5 -> muon muon)"
      IF(BRLL(5).GT.0d0)
     .  WRITE(16,905) BRLL(5),2,15,-15,"BR(H_5 -> tau tau)"
      IF(BRCC(5).GT.0d0)
     .  WRITE(16,905) BRCC(5),2,4,-4,"BR(H_5 -> c cbar)"
      IF(BRBB(5).GT.0d0)
     .  WRITE(16,905) BRBB(5),2,5,-5,"BR(H_5 -> b bbar)"
      IF(BRTT(5).GT.0d0)
     .  WRITE(16,905) BRTT(5),2,6,-6,"BR(H_5 -> t tbar)"
      IF(BRGG(5).GT.0d0)
     .  WRITE(16,905) BRGG(5),2,22,22,"BR(H_5 -> gamma gamma)"
      IF(BRZG(5).GT.0d0)
     .  WRITE(16,905) BRZG(5),2,23,22,"BR(H_5 -> Z gamma)"
      IF(BRHHH(5,1).GT.0d0)
     .  WRITE(16,905) BRHHH(5,1),2,25,25,"BR(H_5 -> H_1 H_1)"
      IF(BRHHH(5,2).GT.0d0)
     .  WRITE(16,905) BRHHH(5,2),2,25,35,"BR(H_5 -> H_1 H_2)"
      IF(BRHHH(5,3).GT.0d0)
     .  WRITE(16,905) BRHHH(5,3),2,35,35,"BR(H_5 -> H_2 H_2)"
      IF(BRHHH(5,4).GT.0d0)
     .  WRITE(16,905) BRHHH(5,4),2,25,45,"BR(H_5 -> H_1 H_3)"
      IF(BRHHH(5,5).GT.0d0)
     .  WRITE(16,905) BRHHH(5,5),2,35,45,"BR(H_5 -> H_2 H_3)"
      IF(BRHHH(5,6).GT.0d0)
     .  WRITE(16,905) BRHHH(5,6),2,45,45,"BR(H_5 -> H_3 H_3)"
      IF(BRHHH(5,7).GT.0d0)
     .  WRITE(16,905) BRHHH(5,7),2,25,36,"BR(H_5 -> H_1 H_4)"
      IF(BRHHH(5,8).GT.0d0)
     .  WRITE(16,905) BRHHH(5,8),2,35,36,"BR(H_5 -> H_2 H_4)"
      IF(BRHHH(5,9).GT.0d0)
     .  WRITE(16,905) BRHHH(5,9),2,45,36,"BR(H_5 -> H_3 H_4)"
      IF(BRHHH(5,10).GT.0d0)
     .  WRITE(16,905) BRHHH(5,10),2,36,36,"BR(H_5 -> H_4 H_4)"
      IF(BRHCHC(5).GT.0d0)
     .  WRITE(16,905) BRHCHC(5),2,37,-37,"BR(H_5 -> H+ H-)"
      IF(BRHAZ(5,1).GT.0d0)
     .  WRITE(16,905) BRHAZ(5,1),2,23,25,"BR(H_5 -> H_1 Z)"
      IF(BRHAZ(5,2).GT.0d0)
     .  WRITE(16,905) BRHAZ(5,2),2,23,35,"BR(H_5 -> H_2 Z)"
      IF(BRHAZ(5,3).GT.0d0)
     .  WRITE(16,905) BRHAZ(5,3),2,23,45,"BR(H_5 -> H_3 Z)"
      IF(BRHAZ(5,4).GT.0d0)
     .  WRITE(16,905) BRHAZ(5,4),2,23,36,"BR(H_5 -> H_4 Z)"
      IF(BRHCW(5).GT.0d0)
     .  WRITE(16,905) BRHCW(5),2,24,-37,"BR(H_5 -> W+ H-)"
      IF(BRHCW(5).GT.0d0)
     .  WRITE(16,905) BRHCW(5),2,-24,37,"BR(H_5 -> W- H+)"
     ...
     .    "BR(H_5 -> cha_2 cha_2bar)"
      IF(BRHSQ(5,1).GT.0d0)
     .  WRITE(16,905) BRHSQ(5,1),2,1000002,-1000002,
     .    "BR(H_5 -> ~u_L ~ubar_L)"
      IF(BRHSQ(5,1).GT.0d0)
     .  WRITE(16,905) BRHSQ(5,1),2,1000004,-1000004,
     .    "BR(H_5 -> ~c_L ~cbar_L)"
      IF(BRHSQ(5,2).GT.0d0)
     .  WRITE(16,905) BRHSQ(5,2),2,2000002,-2000002,
     .    "BR(H_5 -> ~u_R ~ubar_R)"
      IF(BRHSQ(5,2).GT.0d0)
     .  WRITE(16,905) BRHSQ(5,2),2,2000004,-2000004,
     .    "BR(H_5 -> ~c_R ~cbar_R)"
      IF(BRHSQ(5,3).GT.0d0)
     .  WRITE(16,905) BRHSQ(5,3),2,1000001,-1000001,
     .    "BR(H_5 -> ~d_L ~dbar_L)"
      IF(BRHSQ(5,3).GT.0d0)
     .  WRITE(16,905) BRHSQ(5,3),2,1000003,-1000003,
     .    "BR(H_5 -> ~s_L ~sbar_L)"
      IF(BRHSQ(5,4).GT.0d0)
     .  WRITE(16,905) BRHSQ(5,4),2,2000001,-2000001,
     .    "BR(H_5 -> ~d_R ~dbar_R)"
      IF(BRHSQ(5,4).GT.0d0)
     .  WRITE(16,905) BRHSQ(5,4),2,2000003,-2000003,
     .    "BR(H_5 -> ~s_R ~sbar_R)"
      IF(BRHSQ(5,5).GT.0d0)
     .  WRITE(16,905) BRHSQ(5,5),2,1000006,-1000006,
     .    "BR(H_5 -> ~t_1 ~tbar_1)"
      IF(BRHSQ(5,6).GT.0d0)
     .  WRITE(16,905) BRHSQ(5,6),2,2000006,-2000006,
     .    "BR(H_5 -> ~t_2 ~tbar_2)"
      IF(BRHSQ(5,7).GT.0d0)
     .  WRITE(16,905) BRHSQ(5,7),2,1000006,-2000006,
     .    "BR(H_5 -> ~t_1 ~tbar_2)"
      IF(BRHSQ(5,7).GT.0d0)
     .  WRITE(16,905) BRHSQ(5,7),2,2000006,-1000006,
     .    "BR(H_5 -> ~t_2 ~tbar_1)"
      IF(BRHSQ(5,8).GT.0d0)
     .  WRITE(16,905) BRHSQ(5,8),2,1000005,-1000005,
     .    "BR(H_5 -> ~b_1 ~bbar_1)"
      IF(BRHSQ(5,9).GT.0d0)
     .  WRITE(16,905) BRHSQ(5,9),2,2000005,-2000005,
     .    "BR(H_5 -> ~b_2 ~bbar_2)"
      IF(BRHSQ(5,10).GT.0d0)
     .  WRITE(16,905) BRHSQ(5,10),2,1000005,-2000005,
     .    "BR(H_5 -> ~b_1 ~bbar_2)"
      IF(BRHSQ(5,10).GT.0d0)
     .  WRITE(16,905) BRHSQ(5,10),2,2000005,-1000005,
     .    "BR(H_5 -> ~b_2 ~bbar_1)"
      IF(BRHSL(5,1).GT.0d0)
     .  WRITE(16,905) BRHSL(5,1),2,1000011,-1000011,
     .    "BR(H_5 -> ~e_L ~ebar_L)"
      IF(BRHSL(5,1).GT.0d0)
     .  WRITE(16,905) BRHSL(5,1),2,1000013,-1000013,
     .    "BR(H_5 -> ~mu_L ~mubar_L)"
      IF(BRHSL(5,2).GT.0d0)
     .  WRITE(16,905) BRHSL(5,2),2,2000011,-2000011,
     .    "BR(H_5 -> ~e_R ~ebar_R)"
      IF(BRHSL(5,2).GT.0d0)
     .  WRITE(16,905) BRHSL(5,2),2,2000013,-2000013,
     .    "BR(H_5 -> ~mu_R ~mubarRL)"
      IF(BRHSL(5,3).GT.0d0)
     .  WRITE(16,905) BRHSL(5,3),2,1000012,-1000012,
     .    "BR(H_5 -> ~nu_e_L ~nu_ebar_L)"
      IF(BRHSL(5,3).GT.0d0)
     .  WRITE(16,905) BRHSL(5,3),2,1000014,-1000014,
     .    "BR(H_5 -> ~nu_mu_L ~nu_mubar_L)"
      IF(BRHSL(5,4).GT.0d0)
     .  WRITE(16,905) BRHSL(5,4),2,1000015,-1000015,
     .    "BR(H_5 -> ~tau_1 ~taubar_1)"
      IF(BRHSL(5,5).GT.0d0)
     .  WRITE(16,905) BRHSL(5,5),2,2000015,-2000015,
     .    "BR(H_5 -> ~tau_2 ~taubar_2)"
      IF(BRHSL(5,6).GT.0d0)
     .  WRITE(16,905) BRHSL(5,6),2,1000015,-2000015,
     .    "BR(H_5 -> ~tau_1 ~taubar_2)"
      IF(BRHSL(5,6).GT.0d0)
     .  WRITE(16,905) BRHSL(5,6),2,2000015,-1000015,
     ...
     .  WRITE(16,905) HCBRBT,2,6,-5,"BR(H+ -> t bbar)"
      IF(HCBRWH(1).GT.0d0)
     .  WRITE(16,905) HCBRWH(1),2,24,25,"BR(H+ -> W+ H_1)"
      IF(HCBRWH(2).GT.0d0)
     .  WRITE(16,905) HCBRWH(2),2,24,35,"BR(H+ -> W+ H_2)"
      IF(HCBRWH(3).GT.0d0)
     .  WRITE(16,905) HCBRWH(3),2,24,45,"BR(H+ -> W+ H_3)"
      IF(HCBRWH(4).GT.0d0)
     .  WRITE(16,905) HCBRWH(4),2,24,36,"BR(H+ -> W+ H_4)"
      IF(HCBRWH(4).GT.0d0)
     .  WRITE(16,905) HCBRWH(5),2,24,46,"BR(H+ -> W+ H_5)"
