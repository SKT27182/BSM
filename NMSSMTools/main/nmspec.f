...
************************************************************************
      ...
      INTEGER AKFLAG,ALFLAG,UNCERTFLAG,GRFLAG,MWFLAG,CFLAG(6)
      INTEGER IND,strlen
...
!      WRITE(0,*)"A0 =",A0
!      IF(M1FLAG.NE.0)WRITE(0,*)"M1 =",M1INP
!      IF(M2FLAG.NE.0)WRITE(0,*)"M2 =",M2INP
!      IF(M3FLAG.NE.0)WRITE(0,*)"M3 =",M3INP
!      IF(MHUFLAG.NE.0 .AND. MAFLAG.NE.-5)WRITE(0,*)"MHU =",MHUINP
!      IF(MHDFLAG.NE.0 .AND. MAFLAG.NE.-5)WRITE(0,*)"MHD =",MHDINP
!      IF(MAFLAG.EQ.-2 .OR. MAFLAG.EQ.-4)WRITE(0,*)"MS =",MSINP
!      WRITE(0,*)"LAMBDA =",PAR(1)
!      IF(MAFLAG.EQ.-3 .OR. MAFLAG.EQ.-4 .OR. MAFLAG.EQ.-5)
!     . WRITE(0,*)"KAPPA =",PAR(2)
!      IF(ALFLAG.NE.0)WRITE(0,*)"AL =",ALINP
!      IF(AKFLAG.NE.0)WRITE(0,*)"AK =",AKINP
...
*******************************************************************
      ...
      INTEGER OUTFLAG,GRFLAG,MWFLAG,CFLAG(6)
...
*   Check for errors
 ...
 29   CLOSE(15)
     ...
     .  "IF NMSDECAY IS NOT CALLED"
       ERR=1
      ENDIF
      IF(CFLAG(6).NE.0 .AND. NMSFLAG.EQ.0)THEN
...
*********************************************************************
      ...
      INTEGER NSUSY,NGUT,NMES,OUTFLAG,GRFLAG,MWFLAG,CFLAG(6)
      INTEGER PDGH1,PDGH2

      PARAMETER (NSUSY=14,NGUT=21,NMES=21)

      DOUBLE PRECISION PAR(*),PROB(*),SIG(5,8),R
     ...
     . WRITE(16,930) 3,"# MW too large"
      IF(PROB(88).GT.0d0)
     . WRITE(16,930) 3,"# excluded by LHC SUSY searches (SmodelS)"
      IF(PROB(88).LT.0d0)
     ...
     . WRITE(16,930) 4,"# Integration problem in RGES"
      IF(IFAIL.EQ.12)
     . WRITE(16,930) 4,"# Integration problem in RGESUNI"
      IF(IFAIL.EQ.13)
     . WRITE(16,930) 4,"# Integration problem in RGESINV"
     ...
     . WRITE(16,930) 4,"# No electroweak symmetry breaking"
      ...
      IF(CFLAG(6).NE.0)WRITE(16,921) 24,1,"LHC SUSY constraints"
      ...
      WRITE(16,901) 1,M0,"M0(MGUT)"
      WRITE(16,901) 2,M12,"M12(MGUT)"
      WRITE(16,901) 3,TANB,"TANBETA(MZ)"
      IF(MAFLAG.NE.-5)THEN
       WRITE(16,901) 4,SIGMU,"SIGMU"
      ENDIF
      WRITE(16,901) 5,A0,"A0(MGUT)"

      WRITE(16,899) "BLOCK EXTPAR"
      IF(M1FLAG.NE.0)WRITE(16,901) 1,M1INP,"M1 AT THE GUT SCALE"
      IF(M2FLAG.NE.0)WRITE(16,901) 2,M2INP,"M2 AT THE GUT SCALE"
      IF(M3FLAG.NE.0)WRITE(16,901) 3,M3INP,"M3 AT THE GUT SCALE"
      IF(MHDFLAG.NE.0)THEN
       IF(MAFLAG.NE.-5)THEN
        WRITE(16,901) 21,MHDINP,"MHD AT THE GUT SCALE"
       ELSE
        WRITE(16,920) 21,MHDGUT,"MHD AT THE GUT SCALE"
       ENDIF
      ENDIF
      IF(MHUFLAG.NE.0)THEN
       IF(MAFLAG.NE.-5)THEN
        WRITE(16,901) 22,MHUINP,"MHU AT THE GUT SCALE"
       ELSE
        WRITE(16,920) 22,MHUGUT,"MHU AT THE GUT SCALE"
       ENDIF
      ENDIF
      WRITE(16,901) 61,PAR(1),"LAMBDA AT THE SUSY SCALE"
      IF(MAFLAG.EQ.-3 .OR. MAFLAG.EQ.-4 .OR. MAFLAG.EQ.-5)THEN
        WRITE(16,901) 62,PAR(2),"KAPPA AT THE SUSY SCALE"
      ELSE
        WRITE(16,920) 62,PAR(2),"KAPPA AT THE SUSY SCALE"
      ENDIF
      IF(ALFLAG.NE.0)WRITE(16,901) 63,ALINP,"ALAMBDA AT THE GUT SCALE"
      IF(AKFLAG.NE.0)WRITE(16,901) 64,AKINP,"AKAPPA AT THE GUT SCALE"
      IF(MAFLAG.EQ.-5)THEN
       WRITE(16,901) 65,PAR(4),"MUEFF AT THE SUSY SCALE"
      ELSE
       WRITE(16,920) 65,PAR(4),"MUEFF AT THE SUSY SCALE"
      ENDIF
      IF(MAFLAG.EQ.-1 .OR. MAFLAG.EQ.-2 .OR.MAFLAG.EQ.-5)THEN
       IF(XIFINP.NE.0d0)
     .  WRITE(16,901) 66,XIFINP,"XIF AT THE GUT SCALE"
      ELSE
       WRITE(16,920) 66,XIFGUT,"XIF AT THE GUT SCALE"
      ENDIF
      IF(MAFLAG.EQ.-1 .OR. MAFLAG.EQ.-3 .OR.MAFLAG.EQ.-5)THEN
       IF(XISINP.NE.0d0)
     .  WRITE(16,901) 67,XISINP,"XIS AT THE GUT SCALE"
      ELSE
       WRITE(16,920) 67,XISGUT,"XIS AT THE GUT SCALE"
      ENDIF
      IF(MUPINP.NE.0d0)
     .  WRITE(16,901) 68,MUPINP,"MUP AT THE GUT SCALE "
      IF(MSPINP.NE.0d0)
     .  WRITE(16,901) 69,MSPINP,"MSP AT THE GUT SCALE "
      IF(MAFLAG.EQ.-2 .OR. MAFLAG.EQ.-4)THEN
       WRITE(16,901) 70,MSINP,"MS AT THE GUT SCALE"
      ELSE
       WRITE(16,920) 70,MSGUT,"MS AT THE GUT SCALE"
      ENDIF
      IF(M3HINP.NE.0d0)
     .  WRITE(16,901) 72,M3HINP,"M3H AT THE GUT SCALE "
...
*  From IF(OUTFLAG.NE.1)
     ...
     .    " # (STOP/SBOTTOM MASSES)"
      ...
      WRITE(16,903) 1,4,CV(1),"W,Z bosons"
      WRITE(16,903) 1,5,CJ(1),"Gluons"
      WRITE(16,903) 1,6,CG(1),"Photons"
      WRITE(16,899) "# H2"
      WRITE(16,903) 2,1,CU(2),"U-type fermions"
      WRITE(16,903) 2,2,CD(2),"D-type fermions"
      WRITE(16,903) 2,3,CB(2),"b-quarks"
      WRITE(16,903) 2,4,CV(2),"W,Z bosons"
      WRITE(16,903) 2,5,CJ(2),"Gluons"
      WRITE(16,903) 2,6,CG(2),"Photons"
      WRITE(16,899) "# H3"
      WRITE(16,903) 3,1,CU(3),"U-type fermions"
      WRITE(16,903) 3,2,CD(3),"D-type fermions"
      WRITE(16,903) 3,3,CB(3),"b-quarks"
      WRITE(16,903) 3,4,CV(3),"W,Z bosons"
      WRITE(16,903) 3,5,CJ(3),"Gluons"
      WRITE(16,903) 3,6,CG(3),"Photons"
      WRITE(16,899) "# A1"
      WRITE(16,903) 4,1,CU(4),"U-type fermions"
      WRITE(16,903) 4,2,CD(4),"D-type fermions"
      WRITE(16,903) 4,3,CB(4),"b-quarks"
      WRITE(16,903) 4,4,0.,"W,Z bosons"
      WRITE(16,903) 4,5,CJ(4),"Gluons"
      WRITE(16,903) 4,6,CG(4),"Photons"
      WRITE(16,899) "# A2"
      WRITE(16,903) 5,1,CU(5),"U-type fermions"
      WRITE(16,903) 5,2,CD(5),"D-type fermions"
      WRITE(16,903) 5,3,CB(5),"b-quarks"
      WRITE(16,903) 5,4,0.,"W,Z bosons"
      WRITE(16,903) 5,5,CJ(5),"Gluons"
      WRITE(16,903) 5,6,CG(5),"Photons"
     ...
     .   ' # CP-odd Higgs(2)-top-top red. coupling'
      WRITE(16,'(G16.6,G16.6,4I6,a)')CD(1),0d0, 3,PDGH1,15,15,
     .   ' # Higgs(1)-tau-tau red. coupling'
      WRITE(16,'(G16.6,G16.6,4I6,a)')CD(2),0d0, 3,PDGH2,15,15,
     .   ' # Higgs(2)-tau-tau red. coupling'
      WRITE(16,'(G16.6,G16.6,4I6,a)')CD(3),0d0, 3,45,15,15,
     .   ' # Higgs(3)-tau-tau red. coupling'
      WRITE(16,'(G16.6,G16.6,4I6,a)')0d0, CD(4), 3,36,15,15,
     .   ' # CP-odd Higgs(1)-tau-tau red. coupling'
      WRITE(16,'(G16.6,G16.6,4I6,a)')0d0, CD(5), 3,46,15,15,
...
*  From IF(OUTFLAG.NE.1)
     ...
     .        "HTAU(MGUT,DR_bar)"
      ...
      WRITE(16,901) 1,FTGUT(1),"PG=MHU"
      WRITE(16,901) 2,FTGUT(2),"PG=MHD"
      WRITE(16,901) 3,FTGUT(3),"PG=MS"
      WRITE(16,901) 4,FTGUT(4),"PG=M0"
      WRITE(16,901) 5,FTGUT(5),"PG=M1"
      WRITE(16,901) 6,FTGUT(6),"PG=M2"
      WRITE(16,901) 7,FTGUT(7),"PG=M3"
      WRITE(16,901) 8,FTGUT(8),"PG=M12"
      WRITE(16,901) 9,FTGUT(9),"PG=ALAMBDA"
      WRITE(16,901) 10,FTGUT(10),"PG=AKAPPA"
      WRITE(16,901) 11,FTGUT(11),"PG=A0"
      WRITE(16,901) 12,FTGUT(12),"PG=XIF"
      WRITE(16,901) 13,FTGUT(13),"PG=XIS"
      WRITE(16,901) 14,FTGUT(14),"PG=MUP"
      WRITE(16,901) 15,FTGUT(15),"PG=MSP"
      WRITE(16,901) 16,FTGUT(16),"PG=M3H"
      WRITE(16,901) 17,FTGUT(17),"PG=LAMBDA"
      WRITE(16,901) 18,FTGUT(18),"PG=KAPPA"
      WRITE(16,901) 19,FTGUT(19),"PG=HTOP"
      WRITE(16,901) 20,FTGUT(20),"PG=G0"
      WRITE(16,901) 21,FTGUT(21),"PG=MGUT"
      WRITE(16,901) NGUT+1,FTGUT(NGUT+1),"MAX"
      WRITE(16,914) NGUT+2,INT(FTGUT(NGUT+2)),"IMAX"
